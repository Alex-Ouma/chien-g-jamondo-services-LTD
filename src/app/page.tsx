    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-r from-red-900 to-red-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-4">Welcome to KadeshBarnea Services</h1>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link 
              href="/services" 
              className="bg-white text-red-900 px-8 py-3 rounded-lg font-bold hover:bg-red-50 transition"
            >
              Explore Services
            </Link>
            <Link 
              href="/contact" 
              className="bg-red-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-red-800 transition"
            >
              Get In Touch
            </Link>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-8 text-center text-red-900">About Our Company</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-900">Our Mission</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-900">Our Vision</h3>
              <p className="text-gray-700 leading-relaxed">
                KadeshBarnea Services Ltd. is a growing multi-service company based in Misori, Siaya County, 
